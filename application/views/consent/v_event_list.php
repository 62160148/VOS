                    ...
                    <div class="table-responsive">
                        <table class="table" style="width:100%" id="example">
                            ...
                            <tbody>
                                ...
                                <form action="<?php echo site_url() ?>Event_Management/show_event_list_detail_member"
                                    method="post" enctype="multipart/form-data" name="event">
                                    ...
                                    <tr>
                                        ...
                                        width="50" height="50"> มกุล 0</div> -->
                                            <img class="image-cropper"
                                                ...
                                                alt="Card image cap"
                                                width="800px"><?php echo "    " . " " . $arr_event[$i]->evt_name ?>
                                        </td>
                                        <td> <?php {
                                ...
                                <i class='fa fa-edit' style="font-size: 2em; color:#cfb017;"></i></button> </form>
                                </td>
                                <td>
