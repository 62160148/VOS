            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        <h4>Edit User (แก้ไขข้อมูลสมาชิก)</h4>
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-auto m-65">
                                    ...
                                    <img src="<?php echo base_url() . $arr_user->per_image; ?>" id="output" width="400" class="img-user" />
                                    <div class="profile-pic">
                                        <form method="post" id="upload_image" align="center" enctype="multipart/form-data">
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="form-group">
                                            <input class="form-control" type="text" id="per_id" value="<?php echo $arr_user->per_id ?>" hidden>
                                        </div>

                                        <div class="form-group">
                                            <label class="form-control-label">Student ID</label>
                                            <input class="form-control" type="text" id="student_id" value="<?php echo $arr_user->user_name ?>" required>
                                        </div>
                                        <div class="form-group">
                                            <label class="form-control-label">First Name</label>
                                            <input class="form-control" type="text" id="firstname" value="<?php echo $arr_user->per_name ?>" required>
                                        </div>
                                        <div class="form-group">
                                            <label class="form-control-label">Last Name</label>
                                            <input class="form-control" type="text" id="lastname" value="<?php echo $arr_user->per_lastname ?>" required>
                                        </div>

                                        <div class="form-group">
                                            <label for="example-email-input" class="form-control-label">Email</label>
                                            <input class="form-control" type="email" id="email" value="<?php echo $arr_user->per_email ?>" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="example-password-input" class="form-control-label">Password</label>
                                            <div class=" show-password">

                                                <input class="form-control " type="password" id="password" value="<?php echo $arr_user->user_password ?>" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" id="cluster" value="<?php echo $arr_user->per_cls_id ?>" required>
                                        </div>

                                        <div class="form-group">
                                            <label class="form-control-label">Score</label>
                                            <input class="form-control" type="text" id="score" value="<?php echo $arr_user->per_point ?>" required>
                                        </div>

                                        <label class="form-control-label">Role</label>
                                        <div id="role">
                                            <?php if ($arr_user->user_role == '1') { ?>

                                                <input type="radio" id="user" class="role" name="Role" value="1" checked>
                                            ...
                                            <?php } else { ?>
                                                ...
                                                <input type="radio" id="admin" class="role" name="Role" value="2" checked>
                                                <label class="custom-control-label  input-role" for="admin">Admin</label>

                                            <?php } ?>
                                        </div>

                                        <button type="submit" class="btn btn-warning submit mt-4  ">Submit</button>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('form').submit(function(e) {
            ...
            $.ajax({
                url: "/VOS/User_Management/update_edit_user",
                type: "post",
                data: {
                    input_id,
                    input_student_id,
